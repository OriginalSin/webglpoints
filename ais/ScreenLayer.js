/*
 (c) 2018, Sergey Alekseev
 Leaflet.ScreenLayer, plugin for Gemixer screen layers.
*/
L.ScreenLayer = (L.Layer || L.Class).extend({
    ...
    initialize: function (dm, options) {
        L.setOptions(this, L.extend(this.options, options));
        this._observer = dm.addObserver({
			type: 'resend',
			active: false,
			bbox: null,
...
L.screenLayer = function (dm, options) {
    return new L.ScreenLayer(dm, options);
};
